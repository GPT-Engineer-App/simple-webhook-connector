...
**Project**: simple-webhook-connector 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: Please generate a simple UI which allows me to input a phone number and posts a webhook request to this url https://24c6ae20-e6c8-4e33-a26d-8d3c96d82866-00-1175pigntlzx5.riker.replit.dev/first_contact. Additionally it must show the response in pretty printed format.  Use a very simple centered UI. Do not add anything which is not requested 
...
```sh
git clone https://github.com/GPT-Engineer-App/simple-webhook-connector.git
cd simple-webhook-connector
npm i
